...
from leadgen.db import create_all, init_engine, session_scope  # noqa: E402
from leadgen.models import (  # noqa: E402
    Activity,
    Campaign,
    CampaignStatus,
    EmailAccount,
...
from leadgen.services.copywriter import OfferConfig, get_copywriter  # noqa: E402
from leadgen.services.geo import get_geo_service  # noqa: E402
from leadgen.services.niche_advisor import get_niche_advisor  # noqa: E402
from leadgen.services.scrapers.demo import DemoScraper  # noqa: E402
from leadgen.services.sender import new_thread_id  # noqa: E402
from leadgen.services.classifier import classify_reply, summarise  # noqa: E402
...
def seed(leads_per_place: int = 6, with_messages: bool = True) -> dict:
    ...
    with session_scope() as session:
        ...
        if with_messages:
            ...
            for lead, sample in zip(rng.sample(leads, min(5, len(leads))), chosen_samples):
